...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20230814181133_newColumnNames")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.Employee", b =>
                {
                    b.HasOne("WebApplication1.Models.Ability", null)
                        .WithMany("Employees")
                        .HasForeignKey("AbilityId");

                    b.HasOne("WebApplication1.Models.ForeignLanguage", null)
                        .WithMany("Employees")
                        .HasForeignKey("ForeignLanguageId");

                    b.HasOne("WebApplication1.Models.ScientificDegree", null)
                        .WithMany("Employees")
