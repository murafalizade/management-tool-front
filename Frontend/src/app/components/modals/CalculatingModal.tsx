                        ...
                        <Col md={1}>
                          <div className="d-flex ms-4 flex-column mt-3 justify-content-center align-items-center ">
                              ...
                              <label className="normal-label d-flex align-items-center z-index-highest my-2">
                                  <label style={{opacity: aid.vacationMonth === 0 ? 1 : 0
                                                          }} className="normal-label d-flex align-items-center z-index-highest my-2">Verilir</label>
                                <input
                                  type="checkbox"
                                  title="Verilmir"
                              ...
                              <label className="normal-label d-flex align-items-center z-index-highest my-2">
                                                              <label style={{ opacity: aid.bpmMonth === 0 ?1:0}} className="normal-label">Verilir</label>
                                <input
                                  type="checkbox"
                                  title="Verilmir"
                              ...
                              <label className="normal-label d-flex align-items-center z-index-highest my-2">
                                                          <label style={{ opacity: aid.cixisMuvMonth === 0 ?1:0}} className="normal-label">Verilir</label>
                                <input
                                  type="checkbox"
                                  title="Verilmir"
