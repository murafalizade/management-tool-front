          ...
          isLoaded?<Loading />:(
            ...
            <div className="col-md-6 text-center px-3">
              <PieChart
                ...
                data={[employeeCount.financialAid, employeeCount.all - employeeCount.financialAid]}
              />
            </div>
            <div className="col-md-6 text-center px-3">
              <PieChart
                ...
                data={[employeeCount.vacations, employeeCount.all - employeeCount.vacations]}
              />
            </div>
            <div className="col-md-8 text-center px-3">
              <BarChart label="Hərbi rütbələr" data={rankValues} labels={rankNames} />
            </div>
          </div>
          )
        }
